...
Supports user authentication via Supabase Auth (email/password). Local state plus Supabase for data persistence.
...
## Do Not
- Authentication uses Supabase Auth (email/password). Auth pages live in src/features/auth/
